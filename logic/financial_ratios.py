...
def calculate_key_ratios(net_profit, revenue, total_assets):
    """
    Calculates a set of key financial ratios.

    :param net_profit: The net profit for the period.
    :param revenue: The total revenue for the period.
    :param total_assets: The total assets of the business.
    :return: A dictionary containing profit margin and ROA.
    """
    profit_margin = (net_profit / revenue) * 100 if revenue > 0 else 0
    roa = (net_profit / total_assets) * 100 if total_assets > 0 else 0
    return {"profit_margin": profit_margin, "roa": roa}

def calculate_advanced_ratios(current_assets, current_liabilities, total_debt, total_assets, ebitda, interest_expense, operating_cash_flow):
    """
    Calculates advanced financial ratios for liquidity, leverage, and coverage.
    """
